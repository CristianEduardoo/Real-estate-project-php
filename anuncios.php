    ...
    <main class="contenedor comodin">
        ...
        <div class="contenedor-anuncios">
            ...
            <div class="anuncio"> <!-- anuncio 4 -->
                <picture>
                    <source srcset="./build/img/anuncios/anuncio4.webp" type="image/webp">
                    <img loading="lazy" width="200" height="300" src="./build/img/anuncios/anuncio4.jpg" alt="anuncios">
                </picture>
                <div class="contenido-anuncio">
                    <h3>Casa de lujo en el lago</h3>
                    <p>Casa en el lago con exelente vista, acabados de lujo a un exelente precio</p>
            ...
            <div class="anuncio"> <!-- anuncio 5-->
                <picture>
                    <source srcset="./build/img/anuncios/anuncio5.webp" type="image/webp">
                    <img loading="lazy" width="200" height="300" src="./build/img/anuncios/anuncio5.jpg" alt="anuncios">
                </picture>
                <div class="contenido-anuncio">
                    <h3>Casa Centrica en Madrid</h3>
                    <p>Casa con diseño moderno, así como una buena domotica y amueblada
            ...
            <div class="anuncio"> <!-- anuncio 6 -->
                <picture>
                    <source srcset="./build/img/anuncios/anuncio6.webp" type="image/webp">
                    <img loading="lazy" width="200" height="300" src="./build/img/anuncios/anuncio6.jpg" alt="anuncios">
                </picture>
                <div class="contenido-anuncio">
                    <h3>Hermosa casa de lujo</h3>
                    <p>Casa con piscina y acabados de lujo en la ciudad, exelente oportunidad</p>
